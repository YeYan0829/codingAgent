...
> 本文记录 v1 历史实现。D-2026-08-31-01 已取代其中 Active Code 和后续 Working Set 方向；v2 Phase A 已落地，当前代码事实以 `ARCHITECTURE.md` 为准，后续契约见 [Context Management v2 TD](CONTEXT_MANAGEMENT_V2_TECHNICAL_DESIGN.md)。
